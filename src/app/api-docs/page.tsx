...
const endpoints: Endpoint[] = [
  ...
  },
  {
    ...
    returns: "{ rows, total, page, pageSize } — each row has event_at, outcome, hunter_name, target_name, credits, fingerprint, participant ids when the name matches a leaderboard identity, and hunter_stats (current-cycle and archive-total kills, failures, encounters, credits for the hunter role, plus targeted and target_deaths for the target role; the legacy deaths field is failures + target_deaths combined; null when no record exists)",
  },
  {
    path: "/api/hunters",
