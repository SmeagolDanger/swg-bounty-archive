...
export default async function RivalryPage({ params }: { params: Promise<{ hunterId: string; opponent: string }> }) {
  ...
  return <div className="shell">
    ...
    <dl className="metrics profile-metrics">
      ...
      <div className="metric"><dt>Encounters</dt><dd>{data.summary.encounters}</dd><small><LocalDateTime value={data.summary.firstEventAt} kind="date"/> – <LocalDateTime value={data.summary.lastEventAt} kind="date"/></small></div>
