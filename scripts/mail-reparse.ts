...
import { MAIL_PARSER_VERSION, parseMail, parseSale } from "../src/lib/mail/parser";
...
async function main(): Promise<void> {
  ...
  console.log(`Reparsed ${mails.rowCount} mails with parser ${MAIL_PARSER_VERSION}: ${updated} headers refreshed, ${newSales} new sales derived.`);
  await pool.end();
}
